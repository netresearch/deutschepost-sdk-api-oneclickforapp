...
- Upgrade PHPStan to v2.x
- Upgrade Rector to v2.x 
- Upgrade PHPUnit to v10.x
- Modernize codebase with nullable types, constructor promotion, and arrow functions
- Update PHPUnit configuration to v10 format

### Removed

- Support for psr/log v1.x
