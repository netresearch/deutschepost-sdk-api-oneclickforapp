...
{
    public function __construct(private string $username, private string $password, private string $partnerId, private string $partnerKey, private int $keyPhase, private TokenStorageInterface $tokenStorage)
    {
    }
